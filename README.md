...
3. **Automation**: GitHub Actions runs the script every 3 hours, commits changes only when status values shift.
...
## Notes
- Frontenac Islands is not included in this version since a relable data source for the info was not found.
